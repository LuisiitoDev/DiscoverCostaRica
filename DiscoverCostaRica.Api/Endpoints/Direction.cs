...
public class Direction : IEndpoint
{
    public static void Register(WebApplication app)
    {
        app.MapGet(EndpointRoutes.DIRECTIONROUTES.GET_PROVINCES, GetProvinces)
            ...
            .WithOpenApi(OpenApiDirection.GetProvince)
            .Produces<DtoProvince[]>(StatusCodes.Status200OK);

        app.MapGet(EndpointRoutes.DIRECTIONROUTES.GET_CANTONS, GetCantons)
            .WithName("GetCantons")
            .WithOpenApi(OpenApiDirection.GetCantons)
            .Produces<DtoCanton[]>(StatusCodes.Status200OK);

        app.MapGet(EndpointRoutes.DIRECTIONROUTES.GET_DISTRICTS, GetDistricts)
            .WithName("GetDistricts")
            .WithOpenApi(OpenApiDirection.GetDistricts)
            .Produces<DtoDistrict[]>(StatusCodes.Status200OK);
    }
